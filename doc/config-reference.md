...
The active grabber's name shows to the right of the query field. A
failed re-capture (e.g. a closed pane) leaves the current matches and
displayed name untouched rather than clearing the list.
